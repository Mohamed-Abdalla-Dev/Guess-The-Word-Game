...
document.querySelector("footer").innerHTML =
  `${gameName} Game Created By Elzero Web School `;
...
function generateInput() {
  ...
  //Disable All Iputs Except First One
...
function handleGuesses() {
  ...
  if (successGuess) {
    ...
    allTries.forEach((tryDiv) => tryDiv.classList.add());
    ...
    if (el) {
      ...
      //Disabled Guess Button
      guessButton.disabled = true;
      messageArea.innerHTML = `Yuo Lose The Word Is <span>${wordToGuess}</span>`;
    }
  }
}
